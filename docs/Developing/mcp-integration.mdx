...
> 🛠️ This fo generating a custom [MCP Server with Telescope](https://github.com/hyperweb-io/telescope). Looking for the [Hyperweb MCP Server](https://github.com/hyperweb-io/mcp)?  
> Use [MCP integration guide](https://docs.hyperweb.io/mcp-server) to get started.
