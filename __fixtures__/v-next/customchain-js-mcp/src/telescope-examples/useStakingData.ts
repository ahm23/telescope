...
import {
  BondStatus,
  bondStatusToJSON,
} from 'customchain-js/cosmos/staking/v1beta1/staking';
...
import {
  ...
  useGetPool,
} from 'customchain-js/cosmos/staking/v1beta1/query.rpc.react';
import {
  useGetDelegationTotalRewards,
  useGetParams as useDistributionParams,
} from 'customchain-js/cosmos/distribution/v1beta1/query.rpc.react';
