...
## Overview
This guide provides instructions for MCP agents on how to use the telescope generated code in the outputicjs package.
...
import { useSend } from 'outputicjs/cosmos/bank/v1beta1/tx.rpc.react';
```
