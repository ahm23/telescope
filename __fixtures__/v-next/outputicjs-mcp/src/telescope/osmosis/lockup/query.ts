...
export interface QueryParamsResponseAmino {
  params: OsmosisLockupParamsAmino;
}
...
function createBaseQueryParamsResponse(): QueryParamsResponse {
  return {
    params: OsmosisLockupParams.fromPartial({})
  };
}
/**
 * @name QueryParamsResponse
...
export const QueryParamsResponse = {
  ...
  encode(message: QueryParamsResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.params !== undefined) {
      OsmosisLockupParams.encode(message.params, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): QueryParamsResponse {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.params = OsmosisLockupParams.decode(reader, reader.uint32());
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object: DeepPartial<QueryParamsResponse>): QueryParamsResponse {
    const message = createBaseQueryParamsResponse();
    message.params = object.params !== undefined && object.params !== null ? OsmosisLockupParams.fromPartial(object.params) : undefined;
    return message;
  },
  fromAmino(object: QueryParamsResponseAmino): QueryParamsResponse {
    const message = createBaseQueryParamsResponse();
    if (object.params !== undefined && object.params !== null) {
      message.params = OsmosisLockupParams.fromAmino(object.params);
    }
    return message;
  },
  toAmino(message: QueryParamsResponse): QueryParamsResponseAmino {
    const obj: any = {};
    obj.params = message.params ? OsmosisLockupParams.toAmino(message.params) : undefined;
    return obj;
  },
