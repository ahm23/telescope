import { TraversedProtoRoot, ProtoRef, TraverseImport, TraverseAccept, TraverseImplement, TraverseExport, TraverseImportNames, TraversalSymbol } from "@ahm23/telescope-types";
...
export declare class TraverseContext implements TraverseContext {
    ...
    removeImport(filename: string, symbolName: string): void;
